...
export default () => (
  <article>
    <Container className="px-0">
      ...
      <Documentation
        title="Example"
        description={
          <p>Use the <code>&#x3C;BadgeMain&#x3E;</code> component to show and highlight labeled text. You can update the colors using the following modifier classes (ie. <code>bg-primary</code>, <code>bg-secondary</code>):</p>
        }
        scope={{ Badge }}
  ...
  <Badge bg="dark">Dark</Badge>
      ...
      <Documentation
        ...
        description=
        {
          <p>To update the size of the <code>&#x3C;BadgeMain&#x3E;</code> component you can use the size modified classes, such as <code>badge-md</code> or <code>badge-lg</code>.</p>
        }
        scope={{ Badge }}
        imports={`import { Badge } from '@themesberg/react-bootstrap';`}
        example={`<React.Fragment>
  ...
  <Badge pill={true} bg="danger" className="me-1">Danger</Badge>
      ...
      <Documentation
        ...
        description={
          <p>You can also use the <code>&#x3C;BadgeMain&#x3E;</code> component inside other components, such as buttons, alerts, simple paragraphs.</p>
        }
        scope={{ Button, Badge }}
